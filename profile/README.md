...
Full schema: [schema/cup.schema.json](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/cup.schema.json) | Compact format spec: [schema/compact.md](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/compact.md) | Role mappings: [schema/mappings.json](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/mappings.json)
...
Adding a new platform means implementing `PlatformAdapter` — see [cup/_base.py](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/cup/_base.py) for the interface.
...
The compact format applies pruning rules to reduce token count by ~75% while preserving all semantically meaningful and interactive elements. See [schema/compact.md](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/compact.md) for the full spec.

## Documentation

- **[API Reference](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/docs/api-reference.md)** — Session API, actions, envelope format, MCP server
- **[Compact Format Spec](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/compact.md)** — LLM-optimized text format
- **[JSON Schema](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/cup.schema.json)** — Full envelope schema
- **[Role Mappings](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/schema/mappings.json)** — 54 roles mapped across 6 platforms
...
See [CONTRIBUTING.md](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/CONTRIBUTING.md) for setup instructions and guidelines.

## Research

For a deep dive into the problem space — why this standard is needed, what exists today, and how AI agents perceive UIs — see [doc.md](https://github.com/computeruseprotocol/computer-use-protocol/blob/main/doc.md).
